...
def compare_files_with_order(source_file, 
	...
	with open(source_file, 'r') as source, open(comp_file, 'r') as comp, open(write_file, 'a') as write:
		...
		# Removes the beginning characters from each line as needed.
		comp_lines = [x[len(ignore_leading_characters):] for x in comp_lines]

		# Removes values from list that exactly match the given argument.
